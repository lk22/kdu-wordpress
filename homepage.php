...
<div class="container-fluid page content homepage-content">
	...
	<div class="row homepage-content__skills">
		...
		<!-- 
			wrapper
		 -->
		<div class="container skills__wrapper">

			<!-- container -->
			<div class="col-md-4 col-lg-4 skill-container">

				<!-- icon -->
				<div class="skill-container__icon">
					<i class="fa fa-code"></i>
				</div> <!-- icon end -->

				<!-- tagline -->
				<div class="skill-container__tagline">
					<h5 class="text-left">Programming</h5>
				</div><!-- tagline end -->
			...
			<!-- skill container  -->
			<div class="col-md-4 col-md-offset-4 col-lg-4 col-lg-offset-4 skill-container">
				...
				<!-- tagline -->
				<div class="skill-container__tagline">
					<h5 class="text-left">CMS Systemer</h5>
				</div><!-- tagline end -->
